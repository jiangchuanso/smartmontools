...
// Max number of enclosures.  The count field of ps3stor_encl_list is U8
// (255 max), which is sufficient for the supported enclosure counts.
#define PS3STOR_MAX_ENCL_NUM            (255)
